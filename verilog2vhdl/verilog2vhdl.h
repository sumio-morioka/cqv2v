...
//
// verilog2vhdl.h	Verilog2VHDL header file
//
...
#define FUNCRET_SUFFIX		"_RET"			// function return variable
...
#define TITLE "Verilog2VHDL ver1.00(2004/05/06)  Copyright(c) S.Morioka (http://www02.so-net.ne.jp/~morioka/v2v.htm)\n"
